...
@Getter
public class AdoptRequestDetailResponse {
    ...
    public AdoptRequestDetailResponse(Long id, Long boardId, Earning earning, Residence.ResidenceType residenceType, Integer area, Integer roommateNumber, Integer petCount, String adoptReason, Region region, LocalDateTime createDateTime, String writerName, Email writerEmail, String writerPhone) {
        this.id = id;
